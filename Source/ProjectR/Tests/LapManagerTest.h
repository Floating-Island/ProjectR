...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerHasJetsListedWhenSpawnedTest, 
	"ProjectR.LapManager Tests.Integration.001: Has jets listed when spawned", 
	EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)


IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerJetsHaveInitialLapPhaseAsDefaultPhaseTest, 
	"ProjectR.LapManager Tests.Integration.002: Jets have the initial lap phase as the default phase", 
	EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)


IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerJetsHaveInitialLapCountSetToOneTest, 
	"ProjectR.LapManager Tests.Integration.003: Jets have the initial lap count set to one", 
	EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)


IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerJetOverlappingIntermediateChangesPhaseToItFromInitialTest, 
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerJetOverlappingFinalChangesPhaseToItFromIntermediateTest, 
	"ProjectR.LapManager Tests.Integration.005: Jet that overlaps with final phase changes to it when coming from intermediate", 
	EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerJetOverlappingInitialChangesPhaseToItFromFinalTest, 
	"ProjectR.LapManager Tests.Integration.006: Jet that overlaps with initial phase changes to it when coming from final", 
	EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::ProductFilter)


IMPLEMENT_SIMPLE_AUTOMATION_TEST(FALapManagerJetOverlappingInitialIncreasesLapCountFromFinalTest, 
