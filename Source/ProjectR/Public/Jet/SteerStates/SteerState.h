...
public:
	...
	virtual void changesMadeTo(AJet* aJet, FVector& aLinearAcceleration, FVector& anAngularAcceleration, float aSteeringMaximumForce) PURE_VIRTUAL(USteerState::changesMadeTo, ; );//I don't like this. It should be =0 instead of a macro...
};
