...
"C:\Program Files\OpenCppCoverage\opencppcoverage.exe" --sources=\Source --excluded_sources=\Engine --modules %workspace% --excluded_sources=\Tests --excluded_sources=\dev --excluded_sources=\bt --export_type=cobertura:%codeCoverageFile%  -- %testRunnerCommand%