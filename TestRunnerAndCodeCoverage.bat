...
"C:\Program Files\OpenCppCoverage\opencppcoverage.exe" --sources=\Source --excluded_sources=\Engine --excluded_sources=\Tests --export_type=cobertura:%codeCoverageFile%  -- %testRunnerCommand%